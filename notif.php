...
Author URI:
*/
include_once( ABSPATH.'wp-content\plugins\NotifBooking\Widget\Widget_feedback.php');
include_once( ABSPATH.'wp-content\plugins\NotifBooking\Widget\Admin_Widget.php');
...
add_action('generate_after_footer', 'footer');
...
function Footer(){
  include( plugin_dir_path( __FILE__ ) . 'view\footer.php' );
